import { fireEvent, render, screen, configure, waitFor } from '@testing-library/react';
...
const testEmployee: Omit<IEmployee, 'id'> = {
    firstName: 'John',
    lastName: 'Doe',
...
test('Then open a success modal', async () => {
    render(
        <MemoryRouter>
            <Home />
        </MemoryRouter>,
    ...
    expect(inputStartDate.value).toBe("2019/12/31")
    ...
    expect(inputBirthDate.value).toBe("2019/12/31")
